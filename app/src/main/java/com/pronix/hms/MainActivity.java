...
//                animationSecondArist.setBackgroundColor(backgrounColor);
                animationFirstArist.setBackgroundResource(R.mipmap.background);
                animationSecondArist.setBackgroundResource(R.mipmap.background);
                animationCircle.setBackgroundResource(R.mipmap.background);
//                        setCardBackgroundColor(backgrounColor);
                animationSquare.setBackgroundResource(R.mipmap.background);
...
//                        setBackgroundColor(ContextCompat.getColor(MainActivity.this, R.color.colorAccent));
                ((View) animationSquare.getParent()).setBackgroundResource(R.mipmap.background);
//                        setBackgroundColor(ContextCompat.getColor(MainActivity.this, R.color.colorAccent));
